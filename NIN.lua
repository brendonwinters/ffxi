...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Sapience Orb",
		head={ name="Herculean Helm", augments={'Weapon skill damage +3%','Phys. dmg. taken -2%','Damage taken-3%','Accuracy+2 Attack+2',}},
    ...
    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {body="Mochizuki Chainmail",feet="Iga Kyahan +2"})
    ...
    sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS,
		...
		feet={ name="Herculean Boots", augments={'Accuracy+25 Attack+25','Crit.hit rate+2','DEX+11','Accuracy+14','Attack+11',}},
		neck="Caro Necklace",
		waist="Fotia Belt",
    ...
    sets.precast.WS['Exenterator'] = set_combine(sets.precast.WS, {neck="soil gorget", waist="soil belt"})
    --------------------------------------
    -- Midcast sets
    --------------------------------------
    ...
    sets.midcast.FastRecast = {
        ...
        waist="twilight belt",legs="Hachiya Hakama",feet="Iga Kyahan +2",back="Repulse Mantle"}
        
    sets.midcast.Utsusemi = set_combine(sets.midcast.SelfNinjutsu, {neck="magoraga beads",feet="Iga Kyahan +2",back="Andartia's Mantle"})
    ...
    sets.midcast.NinjutsuDebuff = {
        ...
        back="Repulse Mantle",feet="Hachiya Kyahan"}
    ...
    sets.idle = {ammo="Happo Shuriken",
		...
		body="Emet Harness +1",
		hands={ name="Adhemar Wristbands", augments={'DEX+10','AGI+10','Accuracy+15',}},
		legs={ name="Herculean Trousers", augments={'Accuracy+20 Attack+20','Crit. hit damage +3%','DEX+5','Accuracy+12','Attack+15',}},
		feet="Danzo Sune-Ate",
    ...
    sets.engaged.Acc = {ammo="Qirmiz Tathlum",
        head="Whirlpool Mask",neck="Peacock Charm",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Mochizuki Chainmail",hands="Otronif Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Twilight Belt",legs="Hachiya Hakama",feet="Manibozho Boots"}
    ...
    sets.engaged.HighHaste = {ammo="Qirmiz Tathlum",
        ...
        back="Atheling Mantle",waist="Twilight Belt",legs="Hachiya Hakama",feet="Manibozho Boots"}
    ...
    sets.engaged.Acc.MaxHaste = {ammo="Qirmiz Tathlum",
        ...
        back="Yokaze Mantle",waist="Twilight Belt",legs="Manibozho Brais",feet="Manibozho Boots"}
