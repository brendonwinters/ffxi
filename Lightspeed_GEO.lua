...
function init_gear_sets()
    ...
    sets.midcast.FastRecast = {
        ...
        back="lifestream cape",waist="Witful Belt",legs="geomancy pants"}
...
--		back="lifestream cape",legs="bagua pants",feet="Azimuth gaiters"})
    ...
    sets.idle = {main="bolelabunga",sub="genbu's shield",range="Dunna",
        head="Vanya Hood",neck="Twilight Torque",ear1="Hearty Earring",ear2="Eabani Earring",
        body="Vrikodara Jupon",hands="bagua mitaines",ring1="Defending Ring",ring2="Shneddick ring",
        back="Moonbeam Cape",waist="fucho-no-obi",legs="Assiduity Pants",feet="Vanya Clogs"}--geomancy sandals
    ...
    sets.idle.Pet = {main="solstice",sub="genbu's shield",range="Dunna",
        ...
        body="Telchine Chasuble",hands="geomancy mitaines +1",
		ring1="Defending Ring",ring2="Shneddick ring",
        back="Nantosuelta's Cape",waist="isa belt",
    ...
    sets.idle.PDT.Pet = {main="solstice",sub="genbu's shield",range="Dunna",
        head="Azimuth hood",neck="Twilight Torque",ear1="Handler's Earring +1",ear2="Handler's Earring",
        body="hagondes coat +1",hands="geomancy mitaines +1",ring1="Defending Ring",ring2="Shneddick ring",
        back="lifestream cape",waist="fucho-no-obi",legs="telchine braconi",feet="bagua sandals"}
...
--        head="Hike Khat +1",neck="Twilight Torque",ear1="Hearty Earring",ear2="Eabani Earring",
 ...
 --       back="shadow mantle",waist="fucho-no-obi",legs="Assiduity pants +1",feet="geomancy sandals"}
    ...
    sets.defense.PDT = {range="Dunna",
        head="Hike Khat +1",neck="Twilight Torque",ear1="Hearty Earring",ear2="colossus's Earring",
        body="hagondes coat +1",hands="hagondes cuffs +1",ring1="Defending Ring",ring2="Shneddick ring",
        back="Moonbeam mantle",waist="fucho-no-obi",legs="hagondes pants +1",feet="medium's sabots"}

    sets.defense.MDT = {range="Dunna",
        head="Hike Khat +1",neck="Twilight Torque",ear1="Hearty Earring",ear2="colossus's Earring",
        body="hagondes coat +1",hands="hagondes cuffs +1",ring1="Defending Ring",ring2="Shneddick ring",
        back="Moonbeam mantle",waist="fucho-no-obi",legs="gyve trousers",feet="medium's sabots"}
