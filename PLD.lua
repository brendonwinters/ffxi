...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Impatiens",
		...
		back="Rudianos's Mantle"}		--10   55

	sets.precast.FC.Cure = set_combine(sets.precast.FC, {ear1="Mendicant's earring",ear2="Nourishing earring +1",body="jumalik mail"})
   ...
   sets.precast.WS['Atonement'] = {
    ...
    sets.midcast.FastRecast = {ammo="Impatiens",	--10
    ...
    sets.midcast.Enmity = {
		...
		feet="Souveran Schuhs"}						--7 (11 empy)
    ...
    sets.idle = {ammo="Staunch Tathlum",
        head="Valorous mask",neck="Loricate torque +1",ear1="Hearty Earring",ear2="Odnowa Earring +1",
        body="Jumalik mail",hands=OdysseanGauntletsRefresh,ring1="Defending Ring",ring2="Regal Ring",
        back="Moonbeam Cape",waist="Flume Belt +1",legs="Carmine Cuisses +1",feet="Amm greaves"}
    
    sets.idle.Weak = {ammo="homiliary",
        head="jumalik helm",neck="Loricate torque +1",ear1="Hearty Earring",ear2="Ethereal Earring",
...
function change_midcast(spell, equipSet)
        add_to_chat(122, 'midcast change')
		sets.equipSet=equipSet
		coroutine.schedule(
		function()
			windower.send_command('input //gs equip sets.equipSet')
			add_to_chat(122, 'in coroutine')
		end,spell.cast_time*.2)
end
