...
function user_setup()
	...
	state.ExtraDefenseMode = M{['description']='Extra Defense Mode', 'None', 'HP', 'Turms', 'HPTurms', 'Resist', 'Terror', 'Charm','Death'}
...
function init_gear_sets()
	...
	sets.precast.JA['Vallation'] = {body="Runeist coat +1",legs="Futhark trousers +1",back=OgmaPDT}	--relic for inspiration
	...
	sets.precast.HP = {ring1="Moonbeam Ring"}
	...
	sets.precast.WS['Dimidation'] = set_combine(sets.precast.WS, {ammo="Knobkierrie",
		...
		right_ring="Regal Ring",
		back=OgmaDD, })
	sets.precast.WS['Dimidation'].Acc50 = set_combine(sets.precast.WS['Dimidation'], {})
	sets.precast.WS['Dimidation'].Acc100 = set_combine(sets.precast.WS['Dimidation'].Acc50, {})
	sets.precast.WS['Dimidation'].Acc150 = set_combine(sets.precast.WS['Dimidation'].Acc100, {})
	...
	sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS['Resolution'], {head=HercHelmWSD,hands="Meghanada Gloves +2",feet=HercBootsWSD})
	...
	sets.midcast.Cure = set_combine(sets.midcast.FastRecast,{
        ...
        body="Vrikodara Jupon",ring1="Stikini Ring +1",ring2="Stikini Ring +1",--13					
	...
	sets.midcast['Warcry'] = sets.midcast['Flash']
	...
	sets.midcast['Enhancing Magic'] = {head="Erilaz Galea +1",hands="Runeist Mitons +1",legs="Futhark Trousers +1",neck="Incanter's Torque",ear1="Andoaa Earring",ring1="Stikini Ring +1",ring2="Stikini Ring +1"}
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        ...
        body="Runeist Coat +1",hands="Turms Mittens",ring1="Defending Ring",ring2="Stikini Ring +1",
        back="Moonlight Cape",waist="Flume Belt +1",legs="Carmine Cuisses +1",feet=HercBootsRefresh}--29DT 38PDT 34MDT

    sets.idle.PDT = {ammo="Staunch Tathlum +1",
        head=HercHelmDT,neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Odnowa Earring +1",
        body="Runeist Coat +1",hands=HercGlovesDT,ring1="Defending Ring",ring2="Moonbeam ring",
...
--        back="Lupine cape",waist="Flume Belt +1",feet="Luhlaza Charuqs"}
    ...
    sets.HP = {back="Moonlight Cape",}
    sets.Turms = {hands="Turms Mittens",}
	sets.HPTurms = set_combine(sets.HP, sets.Turms)
	sets.Resist = 	{ammo="Staunch Tathlum +1",
		body="Runeist Coat +1",legs="Runeist Trousers +1",feet="Erilaz Greaves +1",
		neck="warder's charm +1",ear1="Hearty earring",ear2="Eabani earring",waist="Engraved Belt",ring2="Purity ring",back=OgmaPDT}
	sets.Terror = 	set_combine(sets.Resist,{})
	sets.Charm =	set_combine(sets.Resist,{neck="Unmoving collar +1",back="Solemnity cape"})
	sets.Death =	{body="Samnuha Coat",ring2="Warden's Ring",}
	...
	sets.engaged.PDT = set_combine(sets.defense.PDT, {})		--51pdt 41mdt	
	sets.engaged.Acc50.PDT = set_combine(sets.engaged.PDT, {body="Ayanmo Corazza +2",legs="Ayanmo Cosciales +2",waist="Ioskeha Belt",ring2="Niqmaddu Ring"})
	sets.engaged.Acc100.PDT = set_combine(sets.engaged.Acc50.PDT, {ear1="Dignitary's Earring",ear2="Telos Earring",back="Evasionist's Cape"})
	sets.engaged.Acc150.PDT = set_combine(sets.engaged.Acc100.PDT, {})
	sets.engaged.Refresh.PDT = set_combine(sets.engaged.PDT, {body="Runeist Coat +1",waist="Fucho-no-obi"})
...
function job_post_precast(spell, action, spellMap, eventArgs)
	...
	if state.ExtraDefenseMode.value == 'HP' or state.ExtraDefenseMode.value == 'HPTurms' then
